...
hira = np.load("npzs/hiragana.npz")['arr_0'].reshape([-1, 127, 128]).astype(np.float32)
...
np.savez_compressed("npzs/hiragana_train_images.npz", train_images)
np.savez_compressed("npzs/hiragana_train_labels.npz", train_labels)
np.savez_compressed("npzs/hiragana_test_images.npz", test_images)
np.savez_compressed("npzs/hiragana_test_labels.npz", test_labels)