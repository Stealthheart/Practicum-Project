...
np.savez_compressed("npzs/katakana_train_images.npz", train_images)
np.savez_compressed("npzs/katakana_train_labels.npz", train_labels)
np.savez_compressed("npzs/katakana_test_images.npz", test_images)
np.savez_compressed("npzs/katakana_test_labels.npz", test_labels)
